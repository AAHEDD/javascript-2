...
try {
  ...
  const typeofTests = [
    ...
    { name: 'obj, true', args: [true], expected:  'boolean' },
    { name: 'num, NaN', args: [NaN], expected: 'number' },
    { name: 'str', args:[ 'What u see is what u get'], expected: 'string' },
    { name: 'undefined', args: [undefined], expected: 'undefined' },
    { name: 'boo', args: [true], expected: 'boolean' },
    { name: 'obj', args: [null], expected: 'object' },
  ]
